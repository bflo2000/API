...
class Image(models.Model):
    ...
    image_filename = models.CharField(max_length=128)
    image_height = models.IntegerField()
    image_width = models.IntegerField()
    short_title = models.CharField(max_length=2000, null=True, blank=True)
    source_title = models.CharField(max_length=2000, null=True, blank=True)
    image_title = models.CharField(max_length=2000, null=True, blank=True)
    ...
    image_description = models.CharField(max_length=10000, null=True, blank=True)
    ...
    additional_keywords_source = models.CharField(max_length=2000, null=True, blank=True)
